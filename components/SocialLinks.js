export default function SocialLinks() {
  return (
    <footer className="relative pb-12 text-center">
      <p className="mb-6 text-xs text-muted select-none">{">"} find_me —&gt;</p>
      <div className="flex items-center justify-center gap-6">
        {/* GitHub */}
        <a
          href="https://github.com/AdNarayan"
          target="_blank"
          rel="noreferrer"
          aria-label="GitHub"
        ...
        {/* Twitter / X */}
        <a
          href="https://x.com/stupiddoomlol"
          target="_blank"
          rel="noreferrer"
          aria-label="X"
          className="text-muted transition-all duration-300 hover:text-accent hover:scale-110"
        ...
        {/* Instagram */}
        <a
          href="https://instagram.com/stupiddoom"
          target="_blank"
          rel="noreferrer"
